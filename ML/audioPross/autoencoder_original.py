...
class VAE:
    ...
    def load_model_tf(self, save_folder):
        ...
        self.model = tf.keras.models.load_model(save_path,
                                                custom_objects={'L__sample_point_from_normal_distribution': self.L__sample_point_from_normal_distribution,
                                                                '_calculate_combined_loss': self._calculate_combined_loss})

    @classmethod
    def load_model_tf_external(cls, save_folder):
        print(save_folder)
        save_path = os.path.join(save_folder, "full_model.tf")
        print(save_path)
        return tf.keras.models.load_model(save_path,
                                          custom_objects={'L__sample_point_from_normal_distribution': VAE.L__sample_point_from_normal_distribution,
                                                          '_calculate_combined_loss': VAE._calculate_combined_loss})
    ...
    def _add_bottleneck(self, x):
        ...
        x = self.L__sample_point_from_normal_distribution(
            name="sample_point_lambda")([self.mu, self.log_variance])
        return x
